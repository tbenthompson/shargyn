...
\begin{figure}[h!]
  \centering
  \includegraphics[width = 6in, height = 4.2in]{fault_map.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width = 6in, height = 8.07in]{khantaishir_joint.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width = 4in, height = 4.53in]{faultscollage.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width = 6in, height = 5.83in]{haliun_joint.png}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width = 5in, height = 6.68in]{intersection_wedge_joint.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width = 6in, height = 6.6in]{lil_dariv_joint.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width = 6in, height = 5.85in]{neshargyn_joint.png}
