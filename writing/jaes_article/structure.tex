...
\begin{figure}[p!]
  \centering
  \includegraphics[width = 6in, height = 3.46in]{fault_map.png}
...
\begin{figure}[p!]
  \centering
  \includegraphics[width = 6in]{khantaishir_joint.png}
...
\begin{figure}[p!]
  \centering
  \includegraphics[width = 4in]{faultscollage.png}
...
\begin{figure}[p!]
  \centering
  \includegraphics[width = 6in]{haliun_joint.png}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width = 5in]{intersection_wedge_joint.png}
...
\begin{figure}[p!]
  \centering
  \includegraphics[width = 6in]{lil_dariv_joint.png}
...
\begin{figure}[p!]
  \centering
  \includegraphics[width = 6in]{neshargyn_joint.png}
...
\begin{figure}[p!]
  \centering
  \includegraphics[width = 6in]{eq_locs.png}
